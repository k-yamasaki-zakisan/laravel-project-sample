...
return $settings = array(
     ...
     */
    //'idpNames' => ['test'],
    //'idpNames' => ['mytestidp1', 'test', 'doraever'],
    'idpNames' => ['doraever'],
     ...
     */
    //'logoutRoute' => '/login',
    'logoutRoute' => '/sso/saml2/doraever/login',

    /**
     * Where to redirect after login if no other option was provided
     */
    'loginRoute' => '/login/select',
     ...
     */
     // 'saml2_controller' => '',
     //'saml2_controller' => 'App\Http\Controllers\SSO\SSOController',
);